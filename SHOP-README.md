...
```
https://github.com/RegionallyFamous/wonders-oddities
```
...
If images fail to fetch, confirm the repo is public and that `https://raw.githubusercontent.com/RegionallyFamous/wonders-oddities/main/wonders-bottled-morning.png` loads in a browser tab.
...
The asset repo at `github.com/RegionallyFamous/wonders-oddities` is public. All 34 files are committed to `main`. If you add more products later and need more images, the generation scripts live in the Cowork session that built this catalog.
